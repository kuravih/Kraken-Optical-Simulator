"""Example: Diffraction Grating Transmission"""
...
[SistemMatrix, S_Matrix, N_Matrix, a, b, c, d, EFFL, APP, PPP, C, N, D] = Doublet.Parax(0.4)
print(N)
[SistemMatrix, S_Matrix, N_Matrix, a, b, c, d, EFFL, APP, PPP, C, N, D] = Doublet.Parax(0.5)
print(N)
[SistemMatrix, S_Matrix, N_Matrix, a, b, c, d, EFFL, APP, PPP, C, N, D] = Doublet.Parax(0.6)
print(N)
