...
L1a = Kos.surf(Rc=9.284706570002484e001, Thickness=6.0, Glass="BK7", Diameter=30.0, Axicon=0)
L1b = Kos.surf(Rc=-3.071608670000159e001, Thickness=3.0, Glass="F2", Diameter=30.0)

L1c = Kos.surf(Rc=-7.819730726078505e001, Thickness=9.737604742910693e001, Glass="AIR", Diameter=30.0)
# L1c = Kos.surf(Rc=-7.819730726078505E+001, Thickness=9.737604742910693E+001, Glass=1, Diameter=30.0)
L1c = Kos.surf(Rc=-7.819730726078505e001, Thickness=9.737604742910693e001, Glass="nvk 1.336 50.23 0", Diameter=30.0)
...
Kos.display2d(Doublet, RayosT, 0)
