...
H = -r / 2
vertices = np.array([[p0x, p0y + H, p0z], [p1x, p1y + H, p1z], [p2x, p2y + H, p2z], [p3x, p3y + H, p3z], [p4x, p4y + H, p4z], [p5x, p5y + H, p5z]])

# mesh faces
faces = np.hstack([[3, 0, 1, 2], [3, 3, 4, 5], [4, 0, 1, 4, 3], [4, 1, 2, 5, 4], [4, 0, 2, 5, 3]])  # triangle  # triangle  # rectangle  # rectangle  # rectangle
